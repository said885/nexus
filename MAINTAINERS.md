...
If you find this work valuable and want to support the development of post-quantum privacy, you can donate to the following Bitcoin address:
...
- Document the issue and rationale
- Refer to RFC process (coming in v0.4.0)
...
| Type | SLA |
|:-----|:---:|
| Security vulnerability | 24 hours |
| Bug report | 72 hours |
...
Major versions (0.x.0): Every 3 months
Minor versions (0.x.y): Every month (as needed)
Patches (0.x.z): Weekly (critical security fixes)
